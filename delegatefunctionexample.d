...
else
{
    ...
    Note: it may be possible to create another library mixin template that could parse a function
          signature and pass the necessary strings to delegateFunctionImpl.  If so, then you
          could define your delegateFunctions like this.
...
void main()
{
    ...
    importantWriteln2(&stdout, "Template version called", " like a normal function!");
    ...
    Doesn't work yet
    {
        auto dg = importantWriteln2.createDelegate!(string,string)(&stdout);
        dg("Hello, ", "again");
    }
    */
}
